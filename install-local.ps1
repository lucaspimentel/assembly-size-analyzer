...
<#
.SYNOPSIS
    Builds and installs AssemblySizeAnalyzer from source.

.DESCRIPTION
    This script builds AssemblySizeAnalyzer from source and installs it
    to ~/.local/bin/AssemblySizeAnalyzer (or ~/.local/bin/AssemblySizeAnalyzer.exe on Windows).
...
.EXAMPLE
    ...
    Builds and installs AssemblySizeAnalyzer to ~/.local/bin

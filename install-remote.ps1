...
<#
.SYNOPSIS
    Downloads and installs analyze-assembly-size from GitHub releases.

.DESCRIPTION
    This script downloads a pre-built analyze-assembly-size binary from GitHub releases
    and installs it to ~/.local/bin/analyze-assembly-size (or ~/.local/bin/analyze-assembly-size.exe on Windows).
...
.EXAMPLE
    ...
    Downloads and installs the latest version of analyze-assembly-size.
